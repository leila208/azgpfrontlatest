  ...
  useEffect(() => {
    const getData = async () => {
      let data = await fetch(
        `https://admin.azgpen.com/blog/EmployeeView/`
      ).then((a) => a.json());
      setAbout(data);
    };
    getData();
        ...
        <div className="container">
          <div className="content-longg">
            ...
            <p id="services" className="one">
              • Mədən kəşfiyyatı (Au-Ag-Cu porfir depozitlər), Gədəbəy,
              Azərbaycan 2020-2022 <br />
              • Mədən kəşfiyyatı (Au-Ag-Cu porfir əmanətlər), Zəfər, Azərbaycan
              2020-2022 <br />
              • Mədən Kəşfiyyatı (Pb-Zn-Au mineralizasiya), Həftsavaran, İran
              2021-2022 <br />
              • Mədən Kəşfiyyatı (Qızıl Minerallaşdırma), Esfahan, İran
              2020-2021 <br />
              • Mədən Kəşfiyyatı (Pb-Zn-Au minerallaşması), Kohandan, İran 2021{" "}
              <br />
              • Mədən Kəşfiyyatı (Pb-Zn-Au minerallaşması), Besri, İran 2021{" "}
              <br />
              • Mədən Kəşfiyyatı (Au, Ag və Cu minerallaşma), Cənubi Xorasan,
              İran 2021 <br />
              • Mədən Kəşfiyyatı (porfir və epitermal polimetal yataqları),
              Sistan və Bəlucistan, İran 2021 <br />• Mədən Kəşfiyyatı (porfir
              Au-Cu yatağı), Zərgan çayı sahəsi 2020.
            </p>
          </div>
        </div>
